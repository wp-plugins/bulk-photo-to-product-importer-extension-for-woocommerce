...
== Screenshots ==
12. Bulk Import - Which are, then, automatically converted into WooCommerce Products. Product Titles are automatically generated based on the file name of the photo(s) being imported. You have the option to modify these titles during and after the upload process.
22. Variation Groups - Many photographers don't just sell the individual photos, rather, they sell what the photo is printed on (photo prints, smartphone cases, shirts, posters, etc...). Using Variations: administrators can create unlimited custom Variations and associate a price with that specific Variation.
32. Variation Group Edit - This is how you edit a variation group.
42. User Groups - We understand that sometimes photos need to be kept private. That's why you can give Users access to specific Events, preventing all other Users from being able to view the photos within that event.
51. User Group Edit - This is how you edit a user group.
61. Settings - This is where you can configure the BPTPI.
